  ...
  <body>
	...
	<div class="mian">
		...
		<c:choose>
			...
			<div class="top_left">余额：<span id="balance">${user.userAccount }</span> &nbsp;|&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/customer/recharge.jsp">充值</a></div>
			<div class="top_right">${user.userName }&nbsp;&nbsp;</div>
			</c:when>
			<c:otherwise>
			<div class="top_right"><a href="${pageContext.request.contextPath }/customer/login.html">登录</a>&nbsp;&nbsp;</div>
			</c:otherwise>
			</c:choose>
		</div>
		...
		<div class="center">
			...
			<div class="center_text">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☀ 电量：${powerbank.dumpEnergy } &nbsp;&nbsp;<br>				
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☀ 状态：待使用    &nbsp;&nbsp;<br>
			</div>
			</div>
			<div class="next">  
				<button id="start" >开始租用</button>
			</div>
		</div>
	</div>
   </div>
  	...
  	$(function(){
  		...
  		$("#start").click(function(){
  			if(usr==null||usr==""){
  				...
  				if(balance<0){
  					alert("当前用户余额不足请充值以后再进行租用！");
  				}else{
  					location.href="api-borrow-borrowBicycle?pid=" + pid + "&userName=" + usr;
  				}
  			}
  		});
  	})
